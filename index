...
<head>
  ...
  <title>HBO</title>
  <link rel="icon" href="https://static.wikia.nocookie.net/hbo-max/images/1/1e/HBO-WhiteLogo.png">
...
<body>
  <div class="theme-blue">
    <video data-shaka-player id="video" autoplay height="1080" width="1920" preload="auto" controls
           poster="https://static.wikia.nocookie.net/hbo-max/images/1/1e/HBO-WhiteLogo.png">
    </video>
  </div>
  <script>
    const manifestUri = 'https://linearjitp-playback.astro.com.my/dash-wv/linear/2304/default.mpd';
